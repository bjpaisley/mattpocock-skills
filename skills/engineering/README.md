...
- **[skill-map](./skill-map/SKILL.md)**: Ask which skill or flow fits your situation. A router over the user-invoked skills in this repo.
...
- **[prototype](./prototype/SKILL.md)**: Build a throwaway prototype to answer a design question: a single shareable HTML file that lets anyone drive a state model by clicking buttons.
...
- **[codebase-design](./codebase-design/SKILL.md)**: Shared discipline and vocabulary for designing deep capsules: small interfaces, clean seams, testable through the interface.
